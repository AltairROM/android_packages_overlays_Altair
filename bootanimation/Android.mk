...
$(TARGET_GENERATED_BOOTANIMATION): $(SOONG_ZIP)
	...
	$(hide) tar xfp packages/overlays/Altair/bootanimation/bootanimation.tar -C $(INTERMEDIATES)
	...
	cat packages/overlays/Altair/bootanimation/desc.txt >> $(INTERMEDIATES)/desc.txt
